...
Scene.start = function () {
    ...
    //	Scene.mainLoop(); Temporarily removed to make buttons work
	}
};
...
Scene.mainLoop = function() {
    ...
    time = window.setTimeout(Scene.mainLoop, 10000 /24);
...
//When with Start or Stop buttons are clicked 
function clickDetermination(id){
	console.log(id);
	if (id == "start") {
		 Scene.mainLoop();
	}
